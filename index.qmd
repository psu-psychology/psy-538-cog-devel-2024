...
subtitle: "The development of perception, cognition, & action"
...
- Requires actions on the part of the perceiver
  - Looking
  - Sucking
  - Touching
  - Verbalizing, pointing, pressing buttons
...
:::: {.columns}
::: {.column width="50%"}
![[@Gibson_JJ1979-ej]](https://pictures.abebooks.com/inventory/md/md31565116437.jpg)
:::
::: {.column width="50%"}
![William H. Warren](https://vivo.brown.edu/profile-images/d35/925/edb/95a/46d/0ab/9f0/4cf/bbc/a11/c6/wwarrenj_photo_.jpg){.lightbox}
:::
::::
...
![[Figure 2 from @Qian2021-eu]](include/img/qian-seisler-gilmore-2021-fig02.png)

---

<https://gilmore-lab.github.io/sex-differences-project/analysis/by-participant-plots/contrast-staircase-plots.html>

<https://gilmore-lab.github.io/sex-differences-project/analysis/by-participant-plots/contrast-cum-perf-plots.html>

<https://gilmore-lab.github.io/sex-differences-project/analysis/by-participant-plots/motion-staircase-plots.html>

<https://gilmore-lab.github.io/sex-differences-project/analysis/by-participant-plots/motion-cum-perf-plots.html>
...
- Some (e.g., many measures of motion perception) not mature until adolescence.
- Implications?
...
![Davida Teller](https://www.perkins.org/wp-content/uploads/elearning-media/u2583/rectangular%20cards.jpg)
...
- Known (especially) for research on the visual cliff, reading, [academic "progeny"](https://academictree.org/psych/peopleinfo.php?pid=9585)
...
- Known for collaborations with Herbert Simon, cognitive architectures
...
- Develops across childhood (as does action)
...
```{r fig-qr-code}
this_qr <- qrcode::qr_code("https://psu-psychology.github.io/psy-538-cog-devel-2024/")
plot(this_qr)
```
